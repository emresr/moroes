        ...
        <div className="bg-grey-darkest relative h-full min-h-screen">
          <div className="xl:py-2">
            ...
            <div className="group relative sidebar-item with-children">
              <a
                href="#"
                className="block xl:flex xl:items-center text-center xl:text-left shadow-light xl:shadow-none py-6 xl:py-2 xl:px-4 border-l-4 border-blue-dark xl:bg-black bg-black xl:opacity-75"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <div className="absolute xl:relative hidden xl:block pin-t left-full xl:pin-none w-48 xl:w-auto group-hover:block bg-black z-50 xl:z-auto">
                <a
                  href="#"
                  className="block text-left xl:flex xl:items-center shadow xl:shadow-none py-3 px-3 xl:px-4 border-l-4 border-transparent text-white hover:text-blue-dark text-xs"
                >
                  All Notification
                </a>
                <a
          ...
          <div className="py-4">
            ...
            <div className="px-2">
              <a
                href="#"
                className="flex items-center justify-center py-2 w-full text-xs text-center text-white block bg-blue hover:bg-blue-dark rounded shadow-light font-bold"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
        ...
        <div className="bg-white h-full pt-8">
          <div className="text-center w-full text-grey-darkest">
            ...
            <p className="py-2 text-sm">
              Made by{" "}
              <a href="https://webartisan.be" className="text-black font-bold">
                Simon Depelchin
              </a>
              ,{" "}
              <a
